...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    try {
        $stmt = $pdo->prepare("
            UPDATE hebergements
            SET id_client=?, plan=?, espace=?, bande_passante=?,
...
<div class="content">
    ...
    <div class="topbar">
        ...
        <div class="welcome">
            ...
            <p>
                Modifiez les informations de cet hébergement.
            </p>
            ...
            <div class="form-grid">
                ...
                <div class="form-group full">
                    ...
                    <select name="id_client" required>
                        ...
                        <?php foreach($clients as $c): ?>
                            ...
                            <option
                                value="<?= $c['id'] ?>"
                                <?= $c['id'] == $hebergement['id_client'] ? 'selected' : '' ?>
                            >
                ...
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        name="plan"
                        value="<?= htmlspecialchars($hebergement['plan']) ?>"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        type="number"
                        name="bande_passante"
                        value="<?= $hebergement['bande_passante'] ?>"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?= $hebergement['date_expiration'] ?>"
                        required
                    >
                ...
                <div class="form-group full">
                    ...
                    <select name="statut" required>
                        ...
                        <option
                            value="actif"
                            <?= $hebergement['statut'] == 'actif' ? 'selected' : '' ?>
                        >
                            Actif
                        </option>
                        ...
                        <option
                            value="expire"
                            <?= $hebergement['statut'] == 'expire' ? 'selected' : '' ?>
                        >
                            Expiré
                        </option>
                        ...
                        <option
                            value="suspendu"
                            <?= $hebergement['statut'] == 'suspendu' ? 'selected' : '' ?>
                        >
                            Suspendu
                        </option>
