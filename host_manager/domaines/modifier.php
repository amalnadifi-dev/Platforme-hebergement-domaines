...
<div class="content">
    ...
    <div class="topbar">
        ...
        <div class="welcome">
            ...
            <p>
                Modifiez les informations de votre domaine depuis cet espace.
            </p>
                    ...
                    <div class="input-wrapper">
                        ...
                        <select name="id_client" required>
                            ...
                            <?php foreach($clients as $c): ?>
                                ...
                                <option
                                    value="<?= $c['id'] ?>"
                                    <?= $c['id'] == $domaine['id_client'] ? 'selected' : '' ?>
                                >
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($domaine['date_enregistrement']) ?>"
                            required
                        >
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($domaine['date_expiration']) ?>"
                            required
                        >
                ...
                <div class="form-group full">
                    ...
                    <div class="input-wrapper status-wrapper">
                        ...
                        <select name="statut" required>
                            ...
                            <option
                                value="expire"
                                <?= $domaine['statut'] == 'expire' ? 'selected' : '' ?>
                            >
                                Expiré
                            </option>
                            ...
                            <option
                                value="suspendu"
                                <?= $domaine['statut'] == 'suspendu' ? 'selected' : '' ?>
                            >
                                Suspendu
                            </option>
